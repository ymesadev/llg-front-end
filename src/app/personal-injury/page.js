...
const TESTIMONIALS = [
  {
    ...
    name: "Roberto G.",
    type: "Auto Accident",
    outcome: "Settlement Won",
    text: "After my car accident, Louis Law Group handled everything while I focused on recovering. They got me a settlement much higher than what the insurance company initially offered.",
  },
  {
    initial: "S",
    name: "Sandra L.",
    type: "Slip & Fall",
    outcome: "Claim Won",
    text: "I slipped in a grocery store and broke my wrist. The store tried to blame me. Louis Law Group proved the store was at fault and I received full compensation for my medical bills and lost wages.",
  },
  {
    initial: "M",
    name: "Marcus T.",
    ...
    text: "Pierre and his team are true professionals. They fought the insurance company at every turn and refused to accept a lowball offer. I'm extremely satisfied with the result.",
  },
  {
    initial: "A",
    name: "Angela P.",
    ...
    text: "I was injured at an apartment complex due to a broken handrail. Louis Law Group investigated, found prior complaints, and held the property owner accountable.",
  },
  {
    initial: "J",
    name: "James W.",
    ...
    text: "My son was bitten by a neighbor's dog and needed stitches and follow-up care. Louis Law Group handled the insurance claim and got us compensation for all medical expenses.",
  },
  {
    initial: "D",
    name: "Diana R.",
    type: "Wrongful Death",
    outcome: "Family Compensated",
    text: "When we lost our father in a car accident, Louis Law Group treated us with compassion while fighting aggressively for our family. They truly cared about our case.",
  },
];
