...
const eligibilityQuestions = [
  ...
  { id: "visited", question: "Did you visit or shop on Vuori's website (vuori.com) within the last 2 years?" },
  { id: "us", question: "Were you located in the United States when you visited Vuori's website?" },
  { id: "submitted", question: "Did you create an account, make a purchase, or submit personal information on Vuori's website?" }
];

export default function VuoriPrivacyLanding() {
  ...
  const faqs = [
    {
      ...
      answer: "This case alleges that Vuori embedded hidden tracking technology on their website that monitored your online activity—including clicks, pages viewed, and personal information—without your knowledge or proper consent, potentially violating state and federal privacy laws."
    },
    {
      question: "Who is eligible to file a claim?",
      answer: "You may be eligible if you visited the Vuori website (vuori.com) within the past 24 months. Certain state residents, particularly those in California, Florida, and other states with strong privacy laws, may have additional protections."
    },
    {
  ...
  const trackingIssues = [
    {
      ...
      description: "Every click, scroll, mouse movement, and page visit on Vuori's website may have been secretly recorded using session replay technology."
    },
    {
          ...
          <div className={styles.heroGrid}>
            <div className={styles.heroText}>
              ...
              <h1 className={styles.heroTitle}>
                Shopped on Vuori's Website?
                <span className={styles.highlight}>Your Data May Have Been Secretly Tracked.</span>
              </h1>
              <p className={styles.heroSubtitle}>
                Vuori, the popular clothing retailer, may have embedded hidden tracking technology
                on their e-commerce website to monitor your online activity—including your clicks,
              ...
              <div className={styles.alertBox}>
                ...
                <p>
                  ...
                  vuori.com in the past 24 months.
                </p>
              </div>
                  ...
                  <form onSubmit={handleSubmit} className={styles.contactForm}>
                    ...
                    <div className={styles.inputGroup}>
                      <input
                        type="email"
                        name="email"
                        placeholder="Email used with Vuori"
        ...
        <div className="container">
          <div className={styles.problemHeader}>
            ...
            <p className={styles.sectionSubtitle}>
              When you visited Vuori's website to browse clothing, shop for activewear, or make a purchase, hidden tracking technology may have been secretly monitoring your every move. This surveillance software—often called "session replay" or "pixel tracking"—records detailed information about your browsing session, including mouse movements, clicks, scrolls, keystrokes, and every page you viewed. All of this happened without your knowledge or meaningful consent, potentially violating your privacy rights under state and federal law.
            </p>
          </div>
            ...
            <div className={styles.eligibilityContent}>
              ...
              <ul className={styles.eligibilityList}>
                <li>
                  ...
                  <span>You visited or shopped on Vuori's website (vuori.com)</span>
                </li>
                <li>
                  <CheckCircle className={styles.checkIcon} />
                  <span>You created an account, made a purchase, or submitted personal information on Vuori's website</span>
                </li>
                <li>
                  <CheckCircle className={styles.checkIcon} />
