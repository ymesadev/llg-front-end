...
const eligibilityQuestions = [
  ...
  { id: "visited", question: "Did you visit American Integrity Insurance's website within the last 2 years?" },
...
export default function AmericanIntegrityPrivacyLanding() {
  ...
  const faqs = [
    {
      ...
      answer: "This case alleges that American Integrity Insurance embedded hidden tracking technology on their website that monitored your online activity—including clicks, pages viewed, and personal information—without your knowledge or proper consent, potentially violating state and federal privacy laws."
    },
    {
      question: "Who is eligible to file a claim?",
      answer: "You may be eligible if you visited the American Integrity Insurance website within the past 24 months. Certain state residents, particularly those in California, Florida, and other states with strong privacy laws, may have additional protections."
    },
    {
  ...
  const trackingIssues = [
    {
      ...
      description: "Every click, scroll, mouse movement, and page visit on the American Integrity Insurance website may have been secretly recorded using session replay technology."
    },
    {
          ...
          <div className={styles.heroGrid}>
            <div className={styles.heroText}>
              ...
              <h1 className={styles.heroTitle}>
                Visited American Integrity Insurance's Website?
                <span className={styles.highlight}>Your Data May Have Been Secretly Tracked.</span>
              </h1>
              <p className={styles.heroSubtitle}>
                American Integrity Insurance may have embedded hidden tracking technology on their website
                  ...
                  <form onSubmit={handleSubmit} className={styles.contactForm}>
                    ...
                    <div className={styles.inputGroup}>
                      <input
                        type="email"
                        name="email"
                        placeholder="Email used with American Integrity Insurance"
        ...
        <div className="container">
          <div className={styles.problemHeader}>
            ...
            <p className={styles.sectionSubtitle}>
              When you visited American Integrity Insurance's website to get a quote, compare coverage options, or explore their services, hidden tracking technology may have been secretly monitoring your every move. This surveillance software—often called "session replay" or "pixel tracking"—records detailed information about your browsing session, including mouse movements, clicks, scrolls, keystrokes, and every page you viewed. All of this happened without your knowledge or meaningful consent, potentially violating your privacy rights under state and federal law.
            </p>
          </div>
            ...
            <div className={styles.eligibilityContent}>
              ...
              <ul className={styles.eligibilityList}>
                <li>
                  ...
                  <span>You visited the American Integrity Insurance website</span>
                </li>
                <li>
                  <CheckCircle className={styles.checkIcon} />
                  <span>You got a quote or purchased insurance online from American Integrity</span>
                </li>
                <li>
                  <CheckCircle className={styles.checkIcon} />
