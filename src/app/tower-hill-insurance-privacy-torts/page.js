...
const eligibilityQuestions = [
  ...
  { id: "visited", question: "Did you visit Tower Hill Insurance's website within the last 2 years?" },
...
export default function TowerHillPrivacyLanding() {
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem('tower-hill-contact', JSON.stringify({
      email: contactInfo.email,
      name: contactInfo.name,
      phone: contactInfo.phone
    }));
    router.push("/tower-hill-insurance-privacy-torts/sign");
  };

  const faqs = [
    {
      question: "What is this privacy case about?",
      answer: "This case alleges that Tower Hill Insurance embedded hidden tracking technology on their website that monitored your online activity—including clicks, pages viewed, and personal information—without your knowledge or proper consent, potentially violating state and federal privacy laws."
    },
    {
      question: "Who is eligible to file a claim?",
      answer: "You may be eligible if you visited the Tower Hill Insurance website within the past 24 months. Certain state residents, particularly those in California, Florida, and other states with strong privacy laws, may have additional protections."
    },
    {
  ...
  const trackingIssues = [
    {
      ...
      description: "Every click, scroll, mouse movement, and page visit on the Tower Hill Insurance website may have been secretly recorded using session replay technology."
    },
    {
          ...
          <div className={styles.heroGrid}>
            <div className={styles.heroText}>
              ...
              <h1 className={styles.heroTitle}>
                Visited Tower Hill Insurance's Website?
                <span className={styles.highlight}>Your Data May Have Been Secretly Tracked.</span>
              </h1>
              <p className={styles.heroSubtitle}>
                Tower Hill Insurance may have embedded hidden tracking technology on their website
              ...
              <div className={styles.alertBox}>
                ...
                <p>
                  ...
                  thig.com in the past 24 months.
                </p>
              </div>
              <div className={styles.heroCtas}>
                <Link href="/tower-hill-insurance-privacy-torts/qualify" className={styles.primaryCta}>
                  ...
                  <form onSubmit={handleSubmit} className={styles.contactForm}>
                    ...
                    <div className={styles.inputGroup}>
                      <input
                        type="email"
                        name="email"
                        placeholder="Email used with Tower Hill Insurance"
        ...
        <div className="container">
          <div className={styles.problemHeader}>
            ...
            <p className={styles.sectionSubtitle}>
              When you visited Tower Hill Insurance's website to get a quote, compare coverage options, or explore their services, hidden tracking technology may have been secretly monitoring your every move. This surveillance software—often called "session replay" or "pixel tracking"—records detailed information about your browsing session, including mouse movements, clicks, scrolls, keystrokes, and every page you viewed. All of this happened without your knowledge or meaningful consent, potentially violating your privacy rights under state and federal law.
            </p>
          </div>
        ...
        <div className="container">
          <div className={styles.stepsGrid}>
            ...
            <div className={styles.stepsLeftColumn}>
              ...
              <Link href="/tower-hill-insurance-privacy-torts/qualify" className={styles.stepsButton}>
            ...
            <div className={styles.eligibilityContent}>
              ...
              <ul className={styles.eligibilityList}>
                <li>
                  ...
                  <span>You visited the Tower Hill Insurance website</span>
                </li>
                <li>
                  <CheckCircle className={styles.checkIcon} />
                  <span>You got a quote or purchased insurance online from Tower Hill</span>
                </li>
                <li>
                  <CheckCircle className={styles.checkIcon} />
              ...
              <Link href="/tower-hill-insurance-privacy-torts/qualify" className={styles.eligibilityCta}>
              ...
              <div className={styles.formCard}>
                ...
                {disqualified ? (
                  ...
                  <div className={styles.eligibilityForm}>
                    ...
                    <Link href="/tower-hill-insurance-privacy-torts/qualify" className={styles.submitButton}>
                      Complete Your Claim
                      <ArrowRight size={20} />
                    </Link>
                  </div>
        ...
        <div className="container">
          <div className={styles.ctaContent}>
            ...
            <div className={styles.ctaButtons}>
              <Link href="/tower-hill-insurance-privacy-torts/qualify" className={styles.ctaPrimary}>
