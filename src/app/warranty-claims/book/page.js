...
export default function BookWarrantyConsultation() {
  useEffect(() => {
      ...
      <div className={styles.card}>
        <div className={styles.cardHeader}>
          <div>
            ...
            <h1>Warranty Claim Consultation</h1>
          </div>
        </div>
        <div className={styles.cardBody}>
          <div className={styles.urgencyBanner}>
            ⚠ Deadlines may apply to warranty and service-contract disputes. Act now to protect your claim by scheduling your free consultation.
          </div>

          <p className={styles.leadCopy}>
            Free consultation with <strong>Louis Law Group</strong> to review your
            warranty or service-contract claim, the company&apos;s response so far, and
            whether we can help you fight a denied, underpaid, or delayed claim.{" "}
            <em>No obligation.</em>
          </p>
