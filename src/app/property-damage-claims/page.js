...
const TESTIMONIALS = [
  {
    ...
    outcome: "$127,000 Recovered",
    text: "Our insurer offered $18,000 for hurricane damage to our roof and interior. Louis Law Group got us $127,000. They brought in their own inspectors and the difference was night and day.",
  },
  {
    initial: "S",
    name: "Sandra K.",
    ...
    text: "Our claim was denied entirely — they said it was a maintenance issue. Louis Law Group proved it was storm damage, and we received full coverage for repairs and mold remediation.",
  },
  {
    initial: "T",
    name: "Thomas H.",
    ...
    text: "Insurance wanted to patch our roof. Our attorney proved the entire roof needed replacement under our policy. They fought for us and the insurer paid in full.",
  },
  {
    initial: "M",
    name: "Maria G.",
    type: "Underpaid Claim",
    outcome: "3x Initial Offer",
    text: "They initially offered $22,000 for significant hurricane damage. Pierre and his team negotiated the claim up to over $68,000. Professional and responsive throughout.",
  },
  {
    initial: "J",
    name: "James P.",
    type: "Fire Damage",
    outcome: "Claim Won",
    text: "After a kitchen fire, our insurer was dragging their feet for months. Louis Law Group took over and got us a settlement within weeks. We could finally start rebuilding.",
  },
  {
    initial: "A",
    name: "Angela D.",
    type: "Insurance Bad Faith",
    outcome: "Full + Damages",
    text: "Our insurer delayed our claim for over a year. Louis Law Group filed a bad faith claim and we received not only the full repair cost but additional damages for the delay.",
  },
];
