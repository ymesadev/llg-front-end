...
export default function FreeCaseEvaluationPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Redirect to retainer page ONLY for Florida + American Home Shield
    if (formData.state === "Florida" && formData.filedCarrier === "American Home Shield") {
    ...
    <form onSubmit={handleSubmit} className={styles.heroForm}>
      ...
      <div className={styles.inputContainer}>
        <select
          ...
          onChange={handleInputChange}
          className={formData.state === "" ? styles.placeholder : ""}
          required
        >
          <option value="" disabled>
            Select State
