...
export default function Hero() {
  useEffect(() => {
    // Animate the left section (title and intro)
    ...
    // Animate the right section (form and evaluation text)
    ...
    // Example: Animate the entire form slightly (optional)
    gsap.from(`.${styles.heroForm}`, {
      ...
      scrollTrigger: {
        ...
        gsap.from(`.${styles.florida},.${styles.litigation}`, {
            ...
            x: -50,     // Start 50px above its final position
            duration: 1, // Animate over 1 second
            ease: "power1.out",
            scrollTrigger: {
              trigger: `.${styles.florida},.${styles.litigation}`,
              start: "top center",
              toggleActions: "play none none reverse",
            },
          });
        ...
        gsap.from(`.${styles.insurance},.${styles.attorneys}`, {
            ...
            duration: 1.3, // Animate over 1 second
            ease: "power1.out",
            scrollTrigger: {
