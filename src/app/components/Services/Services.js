      ...
      <div className="container">
        ...
        <div className={styles.headerServices}>
          ...
          <h2 className={styles.title}>
            ...
            <span className="yellowText">Insurance Claims</span>
          </h2>
        ...
        <div className={`column-4 ${styles.servicesRow}`}>
          <a href="/property-damage-claims" className={styles.serviceBox}>
            <h3>Property Damage</h3>
            <p>
              Property damage law in Florida pertains to damage to tangible
              items, such as vehicles, homes, and personal belongings. Whether
              it’s a hurricane-damaged roof, a fender-bender in a parking lot,
              or vandalism to a storefront, Florida’s legal framework offers
              clarity on determining liability and ensuring rightful
          ...
          >
            <h3>SSDI</h3>
            <p>
              Social Security Disability Insurance (SSDI) is a federally run
              program designed to provide financial support to individuals who
              are unable to work due to a long-term disability. Navigating the
              SSDI process can be intricate, and understanding its aspects
              within the Florida context can be pivotal for claimants.
            </p>
            <span className={styles.arrowCircle}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <a href="/personal-injury-attorneys" className={styles.serviceBox}>
            <h3>Personal Injury</h3>
            <p>
              Personal injury law in Florida is designed to protect individuals
              who have suffered harm due to the negligence or wrongful actions
              of another party. Whether it’s a slip and fall at a store, a car
              accident on I-95, or a medical mishap, Florida’s laws ensure
              victims have a legal pathway to seek compensation.
            </p>
