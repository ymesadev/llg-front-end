...
const eligibilityQuestions = [
  ...
  { id: "visited", question: "Did you visit Slide Insurance's website within the last 2 years?" },
...
export default function SlidePrivacyLanding() {
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem('slide-contact', JSON.stringify({
  ...
  const faqs = [
    {
      ...
      answer: "This case alleges that Slide Insurance embedded hidden tracking technology on their website that monitored your online activity—including clicks, pages viewed, and personal information—without your knowledge or proper consent, potentially violating state and federal privacy laws."
    },
    {
      question: "Who is eligible to file a claim?",
      answer: "You may be eligible if you visited the Slide Insurance website within the past 24 months. Certain state residents, particularly those in California, Florida, and other states with strong privacy laws, may have additional protections."
    },
    {
  ...
  const trackingIssues = [
    {
      ...
      description: "Every click, scroll, mouse movement, and page visit on the Slide Insurance website may have been secretly recorded using session replay technology."
    },
    {
          ...
          <div className={styles.heroGrid}>
            <div className={styles.heroText}>
              ...
              <h1 className={styles.heroTitle}>
                Visited Slide Insurance's Website?
                <span className={styles.highlight}>Your Data May Have Been Secretly Tracked.</span>
              </h1>
              <p className={styles.heroSubtitle}>
                Slide Insurance may have embedded hidden tracking technology on their website
              ...
              <div className={styles.alertBox}>
                ...
                <p>
                  ...
                  slideinsurance.com in the past 24 months.
                </p>
              </div>
              <div className={styles.heroCtas}>
                <Link href="/slide-insurance-privacy-torts/qualify" className={styles.primaryCta}>
                  ...
                  <form onSubmit={handleSubmit} className={styles.contactForm}>
                    ...
                    <div className={styles.inputGroup}>
                      <input
                        type="email"
                        name="email"
                        placeholder="Email used with Slide Insurance"
        ...
        <div className="container">
          <div className={styles.problemHeader}>
            ...
            <p className={styles.sectionSubtitle}>
              When you visited Slide Insurance's website to get a quote, compare coverage options, or explore their services, hidden tracking technology may have been secretly monitoring your every move. This surveillance software—often called "session replay" or "pixel tracking"—records detailed information about your browsing session, including mouse movements, clicks, scrolls, keystrokes, and every page you viewed. All of this happened without your knowledge or meaningful consent, potentially violating your privacy rights under state and federal law.
            </p>
          </div>
        ...
        <div className="container">
          <div className={styles.stepsGrid}>
            ...
            <div className={styles.stepsLeftColumn}>
              ...
              <Link href="/slide-insurance-privacy-torts/qualify" className={styles.stepsButton}>
            ...
            <div className={styles.eligibilityContent}>
              ...
              <ul className={styles.eligibilityList}>
                <li>
                  ...
                  <span>You visited the Slide Insurance website</span>
                </li>
                <li>
                  <CheckCircle className={styles.checkIcon} />
                  <span>You got a quote or purchased insurance online from Slide</span>
                </li>
                <li>
                  <CheckCircle className={styles.checkIcon} />
              ...
              <Link href="/slide-insurance-privacy-torts/qualify" className={styles.eligibilityCta}>
              ...
              <div className={styles.formCard}>
                ...
                {disqualified ? (
                  ...
                  <div className={styles.eligibilityForm}>
                    ...
                    <Link href="/slide-insurance-privacy-torts/qualify" className={styles.submitButton}>
                      Complete Your Claim
                      <ArrowRight size={20} />
                    </Link>
                  </div>
        ...
        <div className="container">
          <div className={styles.ctaContent}>
            ...
            <div className={styles.ctaButtons}>
              <Link href="/slide-insurance-privacy-torts/qualify" className={styles.ctaPrimary}>
