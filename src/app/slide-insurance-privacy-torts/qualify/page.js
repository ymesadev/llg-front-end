...
const eligibilityQuestions = [
  ...
  { id: "visited", question: "Did you visit or interact with Slide Insurance's website (slideinsurance.com) within the last 2 years?", required: true },
  { id: "florida", question: "Were you located in Florida at the time you visited or interacted with Slide Insurance's website?", required: true },
  { id: "submitted", question: "Did you request a quote, create an account, or submit personal information through Slide Insurance's website?", required: true }
];
...
export default function QualifyPage() {
  ...
  useEffect(() => {
    trackEvent("qualify_page_view", { case_type: "slide" });
  }, []);
  ...
  const goToNextStep = () => {
    ...
    if (hasNo) {
      trackEvent("qualify_disqualified", { case_type: "slide", step: currentStep });
    ...
    trackEvent("qualify_step_complete", { case_type: "slide", from_step: currentStep });
    setDirection("next");
    setIsAnimating(true);
      ...
      <div className={styles.container}>
        <div className={styles.content}>
          <div className={styles.disqualified}>
            ...
            <button className={styles.primaryButton} onClick={() => router.push("/slide-insurance-privacy-torts")} >Return to Homepage</button>
          </div>
        </div>
      </div>
    );
                ...
                <>
                  ...
                  <form onSubmit={handleSubmit} className={styles.contactForm}>
                    <div className={styles.inputGroup}>
                      <label htmlFor="usedEmail">Email address used with Slide Insurance</label>
